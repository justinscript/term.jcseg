 ...
 * @author zxc Nov 14, 2014 1:09:31 PM
 */
public class IHashQueue<T extends IWord> {
    ...
    /**
     * remove the node from the head and you should make sure the size is larger than 0 by calling size() before you
     * invoke the method or you will just get null
     * 
     * @param T
     */
    public T remove() {
     ...
     * 
     * @author zxc<zhangxiongcai337@gmail.com>
     */
