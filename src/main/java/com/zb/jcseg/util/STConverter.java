...
/**
 * Simplified and traditional chinese convert class. all the search work base on {@link String#indexOf(int)}. you may
 * store all the words in a HashMap for the purpuse of a faster fetch.
 * 
 * @author zxc Nov 14, 2014 1:14:20 PM
 */
public class STConverter {
    ...
    public static String SimToTraditional(String str) {
        ...
        for (int j = 0; j < str.length(); j++) {
            if ((idx = SIMSTR.indexOf(str.charAt(j))) != -1) sb.append(TRASTR.charAt(idx));
    ...
    public static void SimToTraditional(String str, IStringBuffer isb) {
        int idx;
        for (int j = 0; j < str.length(); j++) {
            if ((idx = SIMSTR.indexOf(str.charAt(j))) != -1) isb.append(TRASTR.charAt(idx));
            else isb.append(str.charAt(j));
        }
    }
    ...
    public static String TraToSimplified(String str) {
        ...
        int idx;
        for (int j = 0; j < str.length(); j++) {
            if ((idx = TRASTR.indexOf(str.charAt(j))) != -1) sb.append(SIMSTR.charAt(idx));
            else sb.append(str.charAt(j));
        }
        return sb.toString();
    }
    ...
    public static void TraToSimplified(String str, IStringBuffer isb) {
        int idx;
        for (int j = 0; j < str.length(); j++) {
            if ((idx = TRASTR.indexOf(str.charAt(j))) != -1) isb.append(SIMSTR.charAt(idx));
            else isb.append(str.charAt(j));
        }
    }
}
