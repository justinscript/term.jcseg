...
public class JcsegTest {
    ...
    public JcsegTest() throws JcsegException, IOException {
        JcsegTokenizerFactory factory = new JcsegTokenizerFactory(Collections.<String, String> emptyMap());
    ...
    public void segment(String str) throws IOException {
        ...
        System.out.format("Done, total:" + seg.getStreamPosition() + ", split:" + +counter
                          + ", cost: %.5fsec(less than)\n", ((float) e - _start) / 1E9);
    }
    ...
    public static void main(String[] args) throws JcsegException, IOException {
        String str = "歧义和同义词:研究生命起源，"
                     + "混合词: 做B超检查身体，我们熟悉的X射线，今天去奇都ktv唱卡拉ok去，"
                     ...
                     + "特殊字母: 【Ⅰ】（Ⅱ），"
                     + "英文数字: bug report zhangxiongcai337@gmail.com or visit http://code.google.com/p/jcseg, 15% of the day's time i will be there."
                     + "特殊数字: ① ⑩ ⑽ ㈩.的";
        ...
        try {
            ...
            System.out.println("|- Suggest email: zhangxiongcai337@gmail.com   |");
